...
function setup() {
  ...
  ground = createSprite(500,450,1200,10);
  ground.velocityX=-4;
 ...
 wallpaper=createSprite(270,250,200,20);
...
background("lightblue")
 ...
 background.velocityX = -4; 
  ...
  textSize(20);
  fill("green");
  text("BEST OF LUCK!", 240,50); 
  
   textSize(20);
  fill("red");
  text("Try to collect all bananas!", 210,20); 
...
function spawnObstacles() {
  if(frameCount % 300 === 0) {
    obstacle = createSprite(500,420,10,40);
